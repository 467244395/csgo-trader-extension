    ...
    <Router>
      <Fragment>
        ...
        <div className="content">
          <Switch>
            <Route exact path="/">
              <Home gAnalytic={ReactGA} />
            </Route>
            <Route path="/changelog">
              <Changelog gAnalytic={ReactGA} />
            </Route>
            <Route path="/release-notes">
              <ReleaseNotes gAnalytic={ReactGA} />
            </Route>
            <Route path="/group">
              <SteamGroup gAnalytic={ReactGA} />
            </Route>
            <Route path="/prices">
              <Prices gAnalytic={ReactGA} />
            </Route>
            <Route path="/privacy">
              <Privacy gAnalytic={ReactGA} />
            </Route>
            <Route path="/faq">
              <Faq gAnalytic={ReactGA} />
            </Route>
            <Route>
              <Redirect to="/" />
            </Route>
